      ...
      <div className="xl:w-[958px] md:w-[650px]  lg:w-[750px] h-auto bg-color1 sm:w-[550px]  rounded-[10px] text-white top-[180px]">
        <div className="p-[57px]">
          ...
          <div className="md:text-lg text-sm font-normal">
            ...
            <br />
            <p>Let’s Order...</p>
            <div className="absolute md:max-w-[100%] md:bottom-[-8px] md:left-[955px] sm:bottom-[-10px] sm:left-[220px] sm:max-w-[80px] right-[21px] bottom-[-10px] max-w-[90px]">
            ...
            <div className="absolute md:max-w-[100%] md:bottom-[-8px] md:left-[650px] sm:bottom-[-10px] sm:left-[220px] sm:max-w-[80px] left-[180px] bottom-[-5px] max-w-[50px]">
